...
export default async function GiaoLyLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] flex flex-col font-sans transition-colors duration-300 pb-24 pt-16 md:pt-20">
      ...
      <section className="relative w-full py-16 sm:py-24 px-4 sm:px-6 lg:px-12 overflow-hidden border-b border-amber-500/20 bg-gradient-to-b from-stone-950 via-stone-900 to-[var(--bg-main)] text-white">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-6 relative z-10">
          ...
          <h1 className="font-serif font-black text-4xl sm:text-6xl text-white tracking-tight leading-tight drop-shadow-md">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-3">
            ...
            <Link
              ...
              className="px-6 py-3 rounded-2xl bg-white/10 hover:bg-white/15 text-stone-200 font-serif font-bold text-xs border border-white/20 backdrop-blur-md transition-all flex items-center gap-2 hover:scale-105"
            >
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform">
                <BookMarked className="w-5 h-5" />
              </div>
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-amber-500">Lời Tựa Khởi Đầu</span>
                  <span className="text-xs text-[var(--text-muted)] font-serif">• CCC 1 – 25</span>
                </div>
                <h3 className="font-serif font-bold text-base sm:text-lg text-[var(--text-main)] group-hover:text-amber-500 transition-colors">
                  Lời Mở Đầu: Sự Sống Của Con Người Là Nhận Biết &amp; Yêu Mến Thiên Chúa
                </h3>
              </div>
            </div>

            <span className="text-xs font-serif font-bold text-amber-500 flex items-center gap-1 group-hover:translate-x-1 transition-transform self-end sm:self-center">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full space-y-10">
        ...
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          <span className="text-xs font-serif font-bold text-amber-600 dark:text-amber-400 uppercase tracking-widest">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="w-14 h-14 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform shadow-inner">
                      <IconComponent className="w-7 h-7" />
                    </div>
                    <span className="font-serif font-black text-sm px-3 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-600 dark:text-amber-300">
                  ...
                  <div className="space-y-1">
                    ...
                    <h3 className="font-serif font-black text-xl text-[var(--text-main)] group-hover:text-amber-500 transition-colors leading-snug">
                      {pillar.title}
                    </h3>
              ...
              >
                <div>
                  ...
                  <div className="p-6 space-y-3">
                    <h3 className="font-serif font-bold text-lg text-[var(--text-main)] group-hover:text-amber-500 transition-colors line-clamp-2 leading-snug">
                      {course.title}
                    </h3>
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-[11px] text-[var(--text-muted)]">
                    <span className="px-2.5 py-0.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 font-bold">
                      {article.category || 'Tín Lý'}
                    </span>
                    <span>{article.reading_time || '5 phút đọc'}</span>
                  </div>
                  <h3 className="font-serif font-bold text-base text-[var(--text-main)] group-hover:text-amber-500 transition-colors line-clamp-2 leading-snug">
                    {article.title}
                  </h3>
                ...
                <div className="pt-3 border-t border-[var(--border-card)]/60 flex items-center justify-between text-xs font-bold text-amber-600 dark:text-amber-400">
