      ...
      <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] flex flex-col">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-4 max-w-md">
            ...
            <Link href="/khoa-hoc" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-amber-500 text-slate-950 font-bold text-sm">
    ...
    <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-main)] selection:bg-amber-500 selection:text-slate-950 transition-colors duration-300 pt-24 sm:pt-28 md:pt-36 pb-20">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[var(--border-card)] pb-4 gap-4">
          <Link href="/khoa-hoc" className="inline-flex items-center text-xs font-bold text-amber-800 dark:text-amber-400 hover:underline transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <>
                  ...
                  {activeLesson.scripture && (
                    <div className="bg-amber-500/5 border border-amber-500/20 p-4 sm:p-6 rounded-2xl flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-amber-800 dark:text-amber-400 mb-1">Lời Chúa</h4>
                  ...
                  {activeLesson.prayer && (
                    <div className="mt-8 bg-blue-500/5 border border-blue-500/20 p-6 rounded-2xl relative overflow-hidden">
                        ...
                        <h4 className="font-bold text-blue-700 dark:text-blue-400 mb-3 text-sm uppercase tracking-wider">Cầu Nguyện</h4>
          ...
          <div className="space-y-6 lg:sticky lg:top-24">
            ...
            <div className="p-6 rounded-3xl bg-[var(--bg-card)] border border-[var(--border-card)] backdrop-blur-xl shadow-2xl flex flex-col max-h-[80vh]">
              <h3 className="font-serif font-bold text-base text-amber-800 dark:text-amber-400 flex items-center gap-2 pb-4 border-b border-[var(--border-card)] mb-4 shrink-0">
                    ...
                    <div className="space-y-2">
                        ...
                        return (
                            ...
                            className={`w-full p-3 rounded-2xl text-left transition-all duration-200 flex items-center justify-between gap-3 border ${
                                isActive
                                ? 'bg-amber-500/10 border-amber-500/50 text-amber-800 dark:text-amber-400 shadow-lg shadow-amber-500/10 scale-[1.02]'
