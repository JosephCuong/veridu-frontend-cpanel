          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="#" className="w-10 h-10 rounded-full bg-[var(--bg-card)] border border-[var(--border-card)] flex items-center justify-center text-[var(--text-muted)] hover:text-red-500 hover:border-red-500 hover:bg-red-500/10 transition-all">
