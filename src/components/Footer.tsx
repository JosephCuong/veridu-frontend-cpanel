            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  aria-label="Kênh RSS Feed Bài Viết VERIDU" 
                  title="Đăng ký RSS Feed"
                  className="w-9 h-9 rounded-xl bg-[var(--bg-card)] border border-[var(--border-card)] flex items-center justify-center text-[var(--text-muted)] hover:text-amber-500 hover:border-amber-500 hover:bg-amber-500/10 transition-all shadow-sm"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6.503 20.752c0 1.794-1.456 3.248-3.251 3.248-1.796 0-3.252-1.454-3.252-3.248 0-1.794 1.456-3.248 3.252-3.248 1.795.001 3.251 1.454 3.251 3.248zm-6.503-12.572v4.811c6.05.062 10.96 4.966 11.022 11.009h4.817c-.062-8.71-7.118-15.758-15.839-15.82zm0-8.18v4.814c10.563.061 19.139 8.631 19.2 19.186h4.797c-.061-13.213-10.786-23.939-23.997-24z"/></svg>
                </a>
              </div>
            </div>
          </div>
