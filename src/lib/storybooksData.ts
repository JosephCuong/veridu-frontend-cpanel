...
export const DEFAULT_STORYBOOKS: StorybookItem[] = [
  {
    ...
    cover_image: '/storybooks/cong-trinh-sang-tao/page_1.webp',
    ...
    pages_data: [
      {
        page_number: 1,
        image_url: '/storybooks/cong-trinh-sang-tao/page_1.webp',
      ...
      {
        page_number: 2,
        image_url: '/storybooks/cong-trinh-sang-tao/page_2.webp',
      ...
      {
        page_number: 3,
        image_url: '/storybooks/cong-trinh-sang-tao/page_3.webp',
      ...
      {
        page_number: 4,
        image_url: '/storybooks/cong-trinh-sang-tao/page_4.webp',
      ...
      {
        page_number: 5,
        image_url: '/storybooks/cong-trinh-sang-tao/page_5.webp',
      ...
      {
        page_number: 6,
        image_url: '/storybooks/cong-trinh-sang-tao/page_6.webp',
      ...
      {
        page_number: 7,
        image_url: '/storybooks/cong-trinh-sang-tao/page_7.webp',
      ...
      {
        page_number: 8,
        image_url: '/storybooks/cong-trinh-sang-tao/page_8.webp',
      ...
      {
        page_number: 9,
        image_url: '/storybooks/cong-trinh-sang-tao/page_9.webp',
      ...
      {
        page_number: 10,
        image_url: '/storybooks/cong-trinh-sang-tao/page_10.webp',
